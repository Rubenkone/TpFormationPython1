...
"""déclarer une chaine de caractere avec str (string) et l'afficher
print(str(nom),nom) ou directement avec print("votre nom est",nom,prenom)"""
#creer une chaine de caractere vide s=srt()
N=str(nom) 
P=str(prenom)
Vnom=nom.isalpha()
